...
y <- Yield214$Yield
library(mgcv)
#gam14 <- gam(Yield ~ Product + s(Northing, bs='bs'), data=Yield214)
#gam14 <- gam(Yield ~ s(Northing, bs='bs'), data=Yield218)
...
```{r}
gam14.ps <- gam(Yield ~ s(Northing,bs="ps"), data=Yield214)
gam16.ps <- gam(Yield ~ s(Northing,bs="ps"), data=Yield216)
gam18.ps <- gam(Yield ~ s(Northing,bs="ps"), data=Yield218)
```

```{r}
plot(Yield214$Northing,predict(gam14.ps),type='l')
lines(Yield216$Northing,predict(gam16.ps),col='red')
lines(Yield218$Northing,predict(gam18.ps),col='blue')
```

#CR (cubic regression?)

```{r}
gam14.cr <- gam(Yield ~ s(Northing,bs="cr"), data=Yield214)
gam16.cr <- gam(Yield ~ s(Northing,bs="cr"), data=Yield216)
gam18.cr <- gam(Yield ~ s(Northing,bs="cr"), data=Yield218)
```

```{r}
plot(Yield214$Northing,predict(gam14.cr),type='l')
lines(Yield216$Northing,predict(gam16.cr),col='red')
lines(Yield218$Northing,predict(gam18.cr),col='blue')
```

```{r}
gam14.prod.cr <- gam(Yield ~ Product + s(Northing,bs="cr"), data=Yield214)
gam16.prod.cr <- gam(Yield ~ Product + s(Northing,bs="cr"), data=Yield216)
gam18.prod.cr <- gam(Yield ~ Product + s(Northing,bs="cr"), data=Yield218)
```

```{r}
plot(Yield214$Northing,predict(gam14.prod.cr),type='l')
lines(Yield216$Northing,predict(gam16.prod.cr),col='red')
lines(Yield218$Northing,predict(gam18.prod.cr),col='blue')
```
