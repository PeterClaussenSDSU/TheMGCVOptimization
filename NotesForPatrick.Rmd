...
Enter data for Easting smoothed yield estimates evaluated at 214m and 216m
...
According to Google AI, this is the code to extract the $X$ matrix

```{r}
predict(gam14, type = "lpmatrix")
